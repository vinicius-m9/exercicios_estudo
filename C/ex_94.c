/**
* Implemente o seu algoritmo Merge Sort ordenando os elementos
* de forma CRESCENTE. Vale ressaltar que o tamanho e os
* elementos do vetor devem ser definidos pelo usuario.
*/
