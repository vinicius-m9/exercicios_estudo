/**
* Calcular e imprimir na tela uma matriz de tamanho LINHA X COLUNA,
* em que seus elementos sao da forma:
*
* a) A[i][j] = 2i + 7j - 2 se i < j;
* b) A[i][j] = 3i^2 - 1 se i = j;
* c) A[i][j] = 4i^3 + 5j^2 + 1 se i > j.
*
* Vale ressaltar que a LINHA e COLUNA deve ser definida pelo USUARIO.
*/
